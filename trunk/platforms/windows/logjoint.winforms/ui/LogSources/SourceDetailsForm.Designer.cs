...
{
	partial class SourceDetailsForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.copyPathLink = new System.Windows.Forms.LinkLabel();
			...
			this.panel1.Controls.Add(this.copyPathLink);
			...
			this.nameTextBox.Size = new System.Drawing.Size(155, 17);
			this.nameTextBox.TabIndex = 4;
			// 
			// copyPathLink
			// 
			this.copyPathLink.AutoSize = true;
			this.copyPathLink.Dock = System.Windows.Forms.DockStyle.Right;
			this.copyPathLink.Location = new System.Drawing.Point(155, 0);
			this.copyPathLink.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.copyPathLink.Name = "copyPathLink";
			this.copyPathLink.Padding = new System.Windows.Forms.Padding(4, 0, 0, 0);
			this.copyPathLink.Size = new System.Drawing.Size(75, 17);
			this.copyPathLink.TabIndex = 5;
			this.copyPathLink.TabStop = true;
			this.copyPathLink.Text = "copy path";
			this.copyPathLink.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.copyPathLink_LinkClicked);
			// 
			// flowLayoutPanel3
			// 
			...
			this.stateLabel.Margin = new System.Windows.Forms.Padding(0, 0, 4, 0);
			this.stateLabel.Name = "stateLabel";
			this.stateLabel.Padding = new System.Windows.Forms.Padding(0, 4, 0, 0);
			this.stateLabel.Size = new System.Drawing.Size(38, 21);
			this.stateLabel.TabIndex = 12;
			this.stateLabel.Text = "state";
			// 
			// stateDetailsLink
			// 
			this.stateDetailsLink.AutoSize = true;
			this.stateDetailsLink.Location = new System.Drawing.Point(46, 0);
			this.stateDetailsLink.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.stateDetailsLink.Name = "stateDetailsLink";
			this.stateDetailsLink.Padding = new System.Windows.Forms.Padding(0, 4, 0, 4);
			this.stateDetailsLink.Size = new System.Drawing.Size(45, 25);
			this.stateDetailsLink.TabIndex = 1;
			this.stateDetailsLink.TabStop = true;
			...
			this.timeOffsetTextBox.TextChanged += new System.EventHandler(this.timeOffsetTextBox_TextChanged);
			// 
			// annotationTextBox
			// 
			...
			this.lastMessageLinkLabel.Click += new System.EventHandler(this.lastBookmarkClicked);
			// 
			...
			this.firstMessageLinkLabel.Click += new System.EventHandler(this.firstBookmarkClicked);
			// 
			// flowLayoutPanel4
			// 
			...
			this.changeColorLinkLabel.Size = new System.Drawing.Size(84, 17);
			this.changeColorLinkLabel.TabIndex = 1;
			this.changeColorLinkLabel.TabStop = true;
			this.changeColorLinkLabel.Text = "pick another";
			this.changeColorLinkLabel.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.changeColorLinkLabel_LinkClicked);
			// 
			// formatTextBox
			// 
		...
		private System.Windows.Forms.TextBox loadedMessagesTextBox;
		...
		private System.Windows.Forms.LinkLabel copyPathLink;

...
namespace LogJoint.Postprocessing.StateInspector
{
    ...
    public class ParentChildRelationChange : Event
    {
        ...
        public ParentChildRelationChange(object? trigger, string objectId, ObjectTypeInfo? objectTypeInfo, string newParentObjectId, int templateId = 0, bool isWeak = false)
            : base(trigger, objectId, objectTypeInfo, templateId)
        {

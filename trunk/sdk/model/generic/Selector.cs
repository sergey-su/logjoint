...
namespace LogJoint
{
    public static class Selectors
    {
        ...
        public static Func<R> Create<A1, A2, A3, A4, A5, A6, A7, R>(
            Func<A1> argSelector1,
            Func<A2> argSelector2,
            Func<A3> argSelector3,
            Func<A4> argSelector4,
            Func<A5> argSelector5,
            Func<A6> argSelector6,
            Func<A7> argSelector7,
            Func<A1, A2, A3, A4, A5, A6, A7, R> resultSelector)
        {
            var memoArg1 = default(A1);
            var cmp1 = GetEqualityComparer<A1>();
            var memoArg2 = default(A2);
            ...
            return () =>
            {
                ...
                var arg5 = argSelector5();
                var arg6 = argSelector6();
                var arg7 = argSelector7();
                if (firstEvaluation || !cmp1.Equals(arg1, memoArg1) || !cmp2.Equals(arg2, memoArg2) || !cmp3.Equals(arg3, memoArg3) || !cmp4.Equals(arg4, memoArg4) || !cmp5.Equals(arg5, memoArg5) || !cmp6.Equals(arg6, memoArg6) || !cmp7.Equals(arg7, memoArg7))
                {
                    firstEvaluation = false;
                    memoRet = resultSelector(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                    memoArg1 = arg1;
                    memoArg2 = arg2;
                    memoArg3 = arg3;
                    memoArg4 = arg4;

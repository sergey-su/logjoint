...
namespace LogJoint
{
    ...
    /// This struct represents a pair of intervals detected by <seealso cref="RulerUtils.GenerateTimeRulerMarks()"/>
    /// </summary>
    public struct TimeRulerIntervals
    {
        public readonly RulerInterval Major, Minor;
        public TimeRulerIntervals(RulerInterval major, RulerInterval minor)
        {
            Major = major;
            Minor = minor;
        }

...
namespace LogJoint.Chromium
{
	public class PluginModel : IPluginModel
	{
		...
		public readonly List<EventsSource<Postprocessing.Timeline.Event, ChromeDriver.Message>.Factory> ChromeDriverTimeLineEventSources =
			new List<EventsSource<Postprocessing.Timeline.Event, ChromeDriver.Message>.Factory>();
